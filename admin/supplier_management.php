        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient p-0 chocolate mynav"  >
            <div class="container-fluid d-flex flex-column p-0 " ><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="user_details.php?id=<?php echo $id?>">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar" style="margin-top: 3cm">
                    ...
                    <li class="nav-item myborder myactive"><a class="nav-link text-center myactivelink" href="#"><span>Supplier Management</span></a></li>
                ...
                <div class="container-fluid"  >
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3" >
                            <p class="text-primary m-0 fw-bold" style="font-size:20px;color:#863e04!important">Supplier Management</p>
                        </div>
                    </div><br>
                         <button class="chocolate" onclick="window.location.href='supplier_register.php?id=<?php echo $id ?>'">
                        ...
                        <p class="text-primary m-0 fw-bold" style="font-size:20px;color:#863e04!important">Registered Supplier Table</p><br>
  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo '   
                                       <tr class="brown">
                                            ...
                                            <td class="shadow-lg">'.$contact.'</td>
                                            <td class="shadow-lg">'.$address.'</td>
                                            <td class="shadow-lg"><center> <button class="btn btn-danger">&nbsp;&nbsp;Delete&nbsp;&nbsp;</button></center></td>
                                        </tr>
                                        ';
  }
?>
...
<div class="modal fade" id="signup" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
  <div class="modal-dialog modal-xl modal-dialog-centered" style="background-color: #745c447b;">
    <button type="button" class="btn-close mymodal" data-bs-dismiss="modal" aria-label="Close" style="margin-top:-22cm"></button>
    <div class="modal-content container modalcontainer" >
      ...
      <div class="modal-body container">
        <P class="container" style="color: #723e0a;">
          You have successfully Register a Supplier.
        </P>

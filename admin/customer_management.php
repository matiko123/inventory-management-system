        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient p-0 chocolate mynav"  >
            <div class="container-fluid d-flex flex-column p-0 " ><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="user_details.php?id=<?php echo $id?>">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar" style="margin-top: 3cm">
                    ...
                    <li class="nav-item myborder myactive"><a class="nav-link text-center myactivelink" href="#"><span>Customer Management</span></a></li>
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">Profile</a>
                                    <div class="dropdown-menu shadow dropdown-menu-end animated--grow-in">
                                        <a class="dropdown-item" href="user_details.php?id=<?php echo $id?>"><i class="fas fa-user fa-sm fa-fw me-2 text-gray-400"></i>&nbsp;Profile</a>
                ...
                <div class="container-fluid"  >
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3" >
                            <p class="text-primary m-0 fw-bold" style="font-size:20px;color:#863e04!important">Customer Management</p>
                        </div>
                    </div><br>
                         <button class="chocolate" onclick="window.location.href='customer_register.php?id=<?php echo $id ?>'">
                        ...
                        <p class="text-primary m-0 fw-bold" style="font-size:20px;color:#863e04!important">Registered Customer Table</p><br>

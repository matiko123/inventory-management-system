...
<body id="page-top" >
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient p-0 chocolate mynav"  >
            <div class="container-fluid d-flex flex-column p-0" ><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="user_details.php?id=<?php echo $id?>">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar" style="margin-top: 3cm">
                    ...
                    <li class="nav-item myborder myactive"><a class="nav-link text-center myactivelink" href="#"><span>Product  Management</span></a></li>
                ...
                <div class="container-fluid"  >
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3" >
                            <p class="text-primary m-0 fw-bold" style="font-size:30px;color:#863e04!important">Product Management</p>
                        </div>
                    </div><br>
                    <div class="container">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="card text-center chocolate " onclick="window.location.href='add_product.php?id=<?php echo $id ?>'" style="cursor:pointer">
                                    <div class="card-body">
                                      <h5 class="card-title">
                            ...
                            <div class="col-md-4" >
                                <div class="card text-center chocolate " onclick="window.location.href='add_prices.php?id=<?php echo $id ?>'" style="cursor:pointer">
                                    <div class="card-body">
                                      <h5 class="card-title">
                                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
                                <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
                                <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                                      ...
                                      Add Product Prices</h5>
                                    </div>
                                  </div>
                            </div>
                            <div class="col-md-4">
                                <div class="card text-center chocolate" onclick="window.location.href='add_description.php?id=<?php echo $id ?>'" style="cursor:pointer">
                                    <div class="card-body ">
                                      <h5 class="card-title">
                                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-plus-square" viewBox="0 0 16 16">
                                <path d="M14 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z"/>
  ...
  while($row = $result->fetch_assoc()) {
    ...
    echo ' 
                                       <tr class="brown">
                                            <td class="shadow-lg"><img class="rounded-circle me-2" width="30" height="30" src="assets/img/avatars/avatar1.jpeg">'.$i.'</td>
                                            ...
                                            <td class="shadow-lg">'.$remains.'</td>
                                            <form method="post">
                                            <input type="hidden" name="product" value="'.$id.'">
                                            <td class="shadow-lg"><center> <button class="btn btn-danger" type="submit">&nbsp;&nbsp;Delete&nbsp;&nbsp;</button></center></td>
                                            </form>
                                        </tr> 
                                        ';
                                        $i++;
